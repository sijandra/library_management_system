...
@Component
public class GetBorrowByUserIdUseCase {
    private final BorrowRepository borrowRepository;

    @Autowired
    public GetBorrowByUserIdUseCase(BorrowRepository borrowRepository) {
        this.borrowRepository = borrowRepository;
    }

    public List<Borrow> execute(Long userId) {
        return borrowRepository.getBorrowByUserId(userId);
    }
}